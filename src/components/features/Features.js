        ...
        <div className="features">
            ...
            <div className="feature_bg">
                ...
                <div className="expandMSG fourthdMSG">
                    ...
                    <div className={expand === 4 ? "messagebox activeMSG activeMSG2" : "messagebox activeMSG2"}>
                ...
                <div className="expandMSG seventhMSG">
                    ...
                    <div className={expand === 7 ? "messagebox activeMSG activeMSG2" : "messagebox activeMSG2"}>
